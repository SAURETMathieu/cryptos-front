...
export default function AnalyticsChartsSection() {
  return (
    <section className="flex flex-wrap items-center justify-center gap-4 p-4">
      <AnalyticsChart title="Balance $" datas={data} />
      <AnalyticsChart title="Balance BTC" datas={data} />
      <AnalyticsChart title="Transactions" datas={data} />
      <AnalyticsChart title="Profits" datas={data} />
    </section>
  );
}
